...
from interactem.app.core.security import verify_password
from interactem.app.models import User, UserCreate
from interactem.app.tests.utils.utils import random_lower_string, random_username
...
def test_delete_user_current_super_user_error(
    ...
    super_user = crud.get_user_by_username(session=db, username=settings.FIRST_SUPERUSER_USERNAME)
    assert super_user
