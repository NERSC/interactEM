<!-- Generated from docs/source/introduction.md using docs/scripts/sync_readmes.py. Do not edit directly. -->
...
1. **Quick start**
    ...
    ```bash
    make setup
    # (optional) then fix your GITHUB_USERNAME/TOKEN in .env
    make docker-up
    make operators
    ```
...
For operators to launch, you need to startup an agent process. See [launching an agent](docs/source/launch-agent.md) for instructions on how to do this.
