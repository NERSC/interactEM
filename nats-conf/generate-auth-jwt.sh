...
nsc add user $FRONTEND_USER_NAME --deny-pubsub ">" --account $CALLOUT_ACCOUNT_NAME -K $CALLOUT_ACCOUNT_SK
...
cp "$XDG_DATA_HOME/nats/nsc/keys/keys/A/${APP_ACCOUNT_SK:1:2}/${APP_ACCOUNT_SK}.nk" $OUTDIR/$APP_ACCOUNT_FILE
